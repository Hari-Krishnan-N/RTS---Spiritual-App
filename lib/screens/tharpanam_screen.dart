...
class TharpanamScreen extends StatefulWidget {
  const TharpanamScreen({super.key});

  @override
  State<TharpanamScreen> createState() => _TharpanamScreenState();
}

class _TharpanamScreenState extends State<TharpanamScreen>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      setState(() {
        _tharpanamStatus = provider.tharpanamStatus;
      });
  ...
  void _createWaves() {
    // Create 3 circular waves with different speeds and sizes - smaller variation for stability
    for (int i = 0; i < 3; i++) {
      _waves.add({
        'scale': 0.75 + (i * 0.12),
  ...
  Widget build(BuildContext context) {
    ...
    // Tharpanam teal gradient matching the dashboard card
    const backgroundGradient = LinearGradient(
      colors: [
        Color(0xFF1B4B47), // Deep muted teal
        Color(0xFF2E706A), // Muted teal
        Color(0xFF3A8A84), // Lighter teal
      ],
                ...
                children: [
                        ...
                        child: Stack(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              width: 160,
                              decoration: BoxDecoration(
                                color: const Color(0xFF0A2627), // Deep teal to match theme
                                shape: BoxShape.circle,
                                boxShadow: [
                                  BoxShadow(
                              ...
                              child: Stack(
                                alignment: Alignment.center,
                                children: [
                                  // Static water ripple background - no animation
                                  Container(
                                    height: 120,
                                    width: 120,
                                    decoration: BoxDecoration(
                                      ...
                                      gradient: RadialGradient(
                                        colors: [
                                          const Color(0xFF4DCFBC).withAlpha(153),
                                          const Color(0xFF39A99A).withAlpha(77),
                                          Colors.transparent,
                                        ],
                                  ...
                                  // ONLY the water droplet icon gets animated with RepaintBoundary
                                  RepaintBoundary(
                  ...
                  Center(
                    child: AnimatedSwitcher(
                      ...
                      child: Container(
                        key: ValueKey<bool>(_tharpanamStatus),
                        padding: const EdgeInsets.all(16),
                        decoration: BoxDecoration(
                          color: _tharpanamStatus 
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Flexible(
                              child: Text(
                                _tharpanamStatus
                                    ? 'You have performed Tharpanam this month'
                                    : 'You have not yet performed Tharpanam this month',
                                style: TextStyle(
                                  fontSize: 16,
                                  color: Colors.white.withAlpha(230),
                                  fontWeight: FontWeight.w500,
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      _buildStatusButton(
                        ...
                        isSelected: _tharpanamStatus,
                        onTap: () {
                          HapticFeedback.mediumImpact();
                          setState(() {
                            _tharpanamStatus = true;
                          });
                          provider.updateTharpanamStatus(true);
                      ...
                      _buildStatusButton(
                        ...
                        onTap: () {
                          ...
                          provider.updateTharpanamStatus(false);
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: isCompleted
                                    ? const Color(0xFF4CAF50).withAlpha(
        ...
        content: Row(
          children: [
            ...
            Flexible(
              child: Text(
                isCompleted
                    ? 'Tharpanam marked as completed for ${DateFormat('MMMM').format(DateTime(selectedYear, selectedMonth))}'
                    : 'Tharpanam marked as not completed for ${DateFormat('MMMM').format(DateTime(selectedYear, selectedMonth))}',
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        padding: const EdgeInsets.all(16),
                        decoration: const BoxDecoration(
                          color: Color(0xFF2E706A), // Match Tharpanam card color
                          shape: BoxShape.circle,
                        ),
                        child: const Icon(
                          Icons.water_drop,
                      ...
                      const Text(
                        ...
                        style: TextStyle(
                          fontSize: 22,
                          fontWeight: FontWeight.bold,
                          color: Color(0xFF2E706A),
                        ),
                      ),
                      const SizedBox(height: 16),
                      const Text(
                        'Tharpanam is a sacred ritual offering of water and sesame seeds performed for ancestors. '
                        'It is typically performed on specific days according to the lunar calendar and is an important part of spiritual practice.',
                        style: TextStyle(
                          fontSize: 16,
                        ...
                        children: [
                          ElevatedButton.icon(
                            ...
                            style: ElevatedButton.styleFrom(
                              backgroundColor: const Color(0xFF2E706A),
  ...
  bool _getMonthStatus(int year, int month) {
    ...
    if (monthData != null && monthData.containsKey('tharpanamStatus')) {
      return monthData['tharpanamStatus'] as bool;
    }
  ...
  void _loadMonthStatus() {
    ...
    if (monthData != null && monthData.containsKey('tharpanamStatus')) {
      setState(() {
        _tharpanamStatus = monthData['tharpanamStatus'] as bool;
      });
    } else {
      setState(() {
        _tharpanamStatus = false;
