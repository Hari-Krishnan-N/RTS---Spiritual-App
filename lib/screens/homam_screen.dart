  ...
  class _HomamScreenState extends State<HomamScreen>
    ...
    final Color _deepRust = const Color(0xFF7D3812); // Deep rust from dashboard card
    final Color _mutedOrange = const Color(0xFFA35735); // Muted orange from dashboard card
      ...
      return Scaffold(
        ...
        appBar: AppBar(
          ...
          systemOverlayStyle: SystemUiOverlayStyle(
            ...
            systemNavigationBarColor: _deepRust,
          ...
          leading: IconButton(
            icon: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: Colors.white.withValues(alpha: 77.0),
                  width: 1,
                ),
              ),
                          ...
                          child: Stack(
                            ...
                            children: [
                                  ...
                                  builder: (context, child) {
                                    return Stack(
                                      ...
                                      children: _flames.map((flame) {
                                        ...
                                        final double flameX = flame['x'] as double;
                                        final double flameY = flame['y'] as double;
                                        final double flameSize = flame['size'] as double;
                                        final double flameSpeed = flame['speed'] as double;
                                        final double flameOpacity = flame['opacity'] as double;
                                        
                                        // Calculate animated flame properties
                                        double yOffset = flameY - 
                                            sin(_animationController.value * pi * flameSpeed) * 15.0;
                                        
                                        double opacity = flameOpacity * 
                                            (0.7 + sin(_animationController.value * pi * flameSpeed) * 0.3);
                                        
                                        double size = flameSize * 
                                            (0.8 + sin(_animationController.value * pi * flameSpeed) * 0.2);
                                        
                                        return Positioned(
                                          left: 100.0 + flameX, 
                                          bottom: 80.0 - yOffset, 
                                          child: Opacity(
                                            opacity: _homamStatus ? opacity : opacity * 0.5,
                                            child: Container(
                                              width: size,
                                              height: size * 1.5, // Taller than wide for flame shape
                                              decoration: BoxDecoration(
                                                color: flame['color'] as Color,
                                                borderRadius: BorderRadius.circular(size / 2.0), // Explicitly use double
                                              ),
                                            ),
                                          ),
                                        );
                              ...
                              Container(
                                ...
                                width: 160,
                                decoration: BoxDecoration(
                                  color: const Color(0xFF5D2A0E), // Deep rust to match theme
                                  shape: BoxShape.circle,
                                  boxShadow: [
                                    BoxShadow(
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        gradient: RadialGradient(
                                          colors: [
                                            _lightOrange.withValues(alpha: 153),
                                            _deepRust.withValues(alpha: 77),
                                            Colors.transparent,
                                          ],
                                          ...
                                          return Transform.rotate(
                                            ...
                                            child: ShaderMask(
                                              ...
                                              child: Icon(
                                                ...
                                                size: 80,
                                                color: _homamStatus ? Colors.white : Colors.white.withValues(alpha: 128),
                                              ),
                                            ),
                                          );
                                        },
                        ...
                        child: AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            color: isCurrentMonth
                                ? Colors.white.withValues(alpha: 77.0)
